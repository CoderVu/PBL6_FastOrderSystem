...
public interface IOrderService {
    ...
    ResponseEntity<APIRespone> updateQuantityProductOrderByProduct(Long productId, int quantity);
    ResponseEntity<APIRespone> updateQuantityProductOrderByCombo(Long comboId, int quantity);
