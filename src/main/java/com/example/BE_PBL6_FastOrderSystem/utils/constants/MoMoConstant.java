package com.example.BE_PBL6_FastOrderSystem.utils.constants;
...
public class MoMoConstant {
    ...
    //public static final String REDIRECT_URL = "http://localhost:8080/api/v1/momo/callback";
    public static final String REDIRECT_URL = "https://pbl6-fastordersystem.onrender.com/api/v1/momo/callback";
   public static final String IPN_URL = "http://localhost:8080/api/v1/momo/ipn";
    public static final String CREATE_ORDER_URL = "https://test-payment.momo.vn/gw_payment/transactionProcessor";
    public static final String NOTIFY_URL = "http://localhost:8080/api/v1/momo/notify";
